...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape' || e.key === 'Esc') {
        if (props.alivero.areAnySubNavsOpen()) {
          props.alivero.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.aliveroNavigation = {
    attach(context) {
