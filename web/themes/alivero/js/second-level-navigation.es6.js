...
((Drupal) => {
  const { isDesktopNav } = Drupal.alivero;
  ...
  Drupal.alivero.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.alivero.isDesktopNav()) return;
  ...
  Drupal.alivero.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.alivero.areAnySubNavsOpen = areAnySubNavsOpen;
